        ...
        <div class="modal-body canvas-editor-body">
          ...
          <div class="ce-controls" id="ce-controls">
            ...
            <div class="ce-section">
              ...
              <input type="range" class="ce-slider" id="ce-textpos" min="0.1" max="0.9" step="0.01" value="0.4">
            </div>
            <!-- Effects -->
            <div class="ce-section">
              <div class="ce-section-title">Effects</div>
              <label class="ce-label">Blend Start <span id="ce-blend-val" class="ce-val">50%</span></label>
              <input type="range" class="ce-slider" id="ce-blend" min="0.1" max="0.9" step="0.01" value="0.5">
              <label class="ce-toggle-row">
