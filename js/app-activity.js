...
(async () => {
    ...
    function renderTab(tab) {
        ...
        switch (tab) {
            case 'history':
                ...
                break;
            case 'liked':
                renderFiltered(content, 'like', true);
                break;
            case 'disliked':
                renderFiltered(content, 'dislike', true);
                break;
            case 'flagged':
                renderFlagged(content);
                break;
            case 'failed':
                renderFailedSources(content);
                break;
        }
    }
    function renderHistory(content) {
        ...
        content.innerHTML = '<div class="activity-list">' + items.map(([url, d]) => '<div class="activity-item" data-url="' + url.replace(/"/g, '&quot;') + '">' +
