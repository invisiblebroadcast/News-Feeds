...
(async () => {
    ...
    function bindTopTabs() {
        el.topTabs.addEventListener('click', e => {
            ...
            if (scope === currentScope && (scope !== 'nation' || nation === currentNation))
                return;
    ...
    function updateStickyHeader(metaText) {
        ...
        if (el.sectionMeta) {
            ...
            if (leftHtml)
                el.sectionMeta.innerHTML = leftHtml;
        }
        if (el.modeToggle) {
        ...
        try {
            ...
            el.main.querySelectorAll('.topic-card').forEach(card => {
                ...
                card.addEventListener('click', e => {
                    if (e.target.closest('.topic-build-btn'))
                        return;
    ...
    function bindNitterControls() {
        ...
        if (clearAll) {
            clearAll.addEventListener('click', () => {
                if (!window.TwitterFetcher || !window.TwitterFetcher.clearCache)
                    return;
                try {
