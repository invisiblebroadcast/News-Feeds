    ...
    async function handleShareImage(article, btn, includeImage) {
        ...
        try {
            ...
            if (article._pubType === 'quote') {
                ...
                // Canvas: image fills entire canvas, text overlays on bottom
                const canvasH = 1350;
                ...
                // Text positioned in the bottom portion (like web: starts at ~58%)
                ...
                const sbGrad = ctx.createRadialGradient(sbX + sbW / 2, sbY + shadowBoxH / 2, sbW * 0.15, sbX + sbW / 2, sbY + shadowBoxH / 2, sbW * 0.55);
